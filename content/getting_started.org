...
*** Text Editor
    A good text editor is a *nix developers most important tool. After enough practice, your editor of choice should feel like an extension of your body.
    There are more text editors for *nix systems then there are Linux Distributions and Window managers.  The two most popular are vi and emacs.
